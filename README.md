...
flowchart TD
    ...
    Input[/Input: Context & Task/]:::success --> G

    subgraph Iterative Multi-Agent Loop
        direction TB
        G[LLM 1: Generator<br>Drafts Output JSON]:::gen --> J[LLM 2: Judge<br>Evaluates Rules & Scores 0-10]:::judge
        
        J --> D{Is Score >= 8?}:::logic
        
        D -- No --> F[Generate Actionable Feedback<br>Detailing Specific Flaws]:::feedback
        F -- Self-Correction --> G
    end
